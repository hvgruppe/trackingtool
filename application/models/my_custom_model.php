...
class My_Custom_model extends grocery_CRUD_Model
{
    function get_list()
    {
		...
		//$this->db->join('ips_productitems','ips_productitems.ordertrackingid = ips_ordertracking.ordertrackingid');
		$this->db->join('ips_productitems','ips_productitems.ordertrackingid = '. $this->table_name . '.ordertrackingid');
